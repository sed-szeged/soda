...
#ifndef DUPLATIONPRIMEPRIORITIZATIONPLUGIN_H
#define DUPLATIONPRIMEPRIORITIZATIONPLUGIN_H
 ...
 */
class DuplationPrimePrioritizationPlugin : public ITestSuitePrioritizationPlugin {
public:

    /**
     * @brief Creates a new instance.
     */
    DuplationPrimePrioritizationPlugin();
    virtual ~DuplationPrimePrioritizationPlugin();
...
private:
    ...
    void updatePartitions(const IndexType tcid);
private:
...
#endif /* DUPLATIONPRIMEPRIORITIZATIONPLUGIN_H */
