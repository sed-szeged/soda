...
/**
 * @brief The JacocoJavaCoverageReaderPlugin class implements methods which reads
 *        gcov data and converts it to statement level coverage data.
 */
class JacocoJavaCoverageReaderPlugin : public ICoverageReaderPlugin
{
public:

    JacocoJavaCoverageReaderPlugin();
    virtual ~JacocoJavaCoverageReaderPlugin();
