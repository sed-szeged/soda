...
#ifndef FAULTDETECTIONMETRICPLUGIN_H
#define FAULTDETECTIONMETRICPLUGIN_H

#include "engine/CKernel.h"

namespace soda {

class FaultDetectionMetricPlugin : public ITestSuiteMetricPlugin
{
public:
...
#endif /* FAULTDETECTIONMETRICPLUGIN_H */
