...
ADD_CUSTOM_COMMAND(TARGET lcov
    COMMAND lcov --remove ./coverage/stap.info \"/usr*\" --output-file ./coverage/stap.info
    WORKING_DIRECTORY ${CMAKE_BINARY_DIR}
    )
ADD_CUSTOM_COMMAND(TARGET lcov
    COMMAND lcov --remove ./coverage/stap.info \"*/test/*\" --output-file ./coverage/stap.info
    WORKING_DIRECTORY ${CMAKE_BINARY_DIR}
    )
ADD_CUSTOM_COMMAND(TARGET lcov
    COMMAND lcov --remove ./coverage/stap.info \"*/googletest/include/*\" --output-file ./coverage/stap.info
    WORKING_DIRECTORY ${CMAKE_BINARY_DIR}
    )
ADD_CUSTOM_COMMAND(TARGET lcov
